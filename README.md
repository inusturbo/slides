[![Release slidev](https://github.com/inusturbo/slides/actions/workflows/release.yaml/badge.svg)](https://github.com/inusturbo/slides/actions/workflows/release.yaml)
# slidev-resources
